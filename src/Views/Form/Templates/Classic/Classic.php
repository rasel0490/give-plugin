        ...
        foreach ($sections as $section) {
            ...
            add_action($end ? : $start, function () {
                ...
                jQuery(document).ready(function( $ ){
                    $('#give-gateway-radio-list li').addClass('give-gateway-list-item');
     $('#give-gateway-radio-list .give-gateway-details').appendTo('.lrpayment-option-details');
     $('.give-gateway-option-selected .give-gateway-details').appendTo('.lrpayment-option-details');
