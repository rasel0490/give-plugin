...
function give_get_donation_form( $args = [] ) {
	...
	?>
	<script type='text/javascript' src='https://platform-api.sharethis.com/js/sharethis.js#property=629724984513ec001959d95c&product=inline-share-buttons' async='async'></script>
    <script type="text/javascript">
    jQuery(document).ready(function( $ ){

	
//Give single Donation page
$(".give-form-templates .story-collapse .showhidebtn").on("click", function () {
	$(".give-form-templates .campain-story").toggleClass("story-active");
	//$(".give-form-templates .document-container").toggleClass("story-active");
});	

$(".give-form-templates .story-collapse .showhidebtn").click(function () {
        $(".give-form-templates .story-collapse .showhidebtn").fadeOut(function () {
            $(".give-form-templates .story-collapse .showhidebtn").text(($(".give-form-templates .story-collapse .showhidebtn").text() == 'Show Story') ? 'Hide Story' : 'Show Story').fadeIn();
        });
    });
    // $(".give-form-templates .give-payment-details-section #give-gateway-radio-list li").addClass('give-gateway-list-item');
    //  $(".give-gateway-details").appendTo(".lrpayment-option-details");
    // $(".give-gateway-list-item").click(function(){
        
    //     setTimeout(function(){ 
    //         console.log($("#give-gateway-radio-list .give-gateway-list-item").html())
    //     $("#give-gateway-radio-list .give-gateway-list-item .give-gateway-details").appendTo(".lrpayment-option-details");
    //     }, 1000);
	...
	<style>
    /*============Start give donation single page style =============*/
    .give_forms-template-default .site-content {
    	border-top: 1px solid #ddd;
    }
    .give_forms-template-default .give-wrap .give_forms {
    	padding-top: 0px;
    }
	.give-form-templates .campain-container {
		display: -webkit-box;
		display: -ms-flexbox;
		display: flex;
	...
	.give-form-templates .campain-col-left, .give-form-templates .campain-col-right {
		margin: 20px 1%;
		width: 48%;
		max-width: 100%;
	}
	.give-form-templates .campain-col-left .img-thumbnail {
    	width: 100%;
    	max-width: 100%;
    }
    .give-form-templates .campain-container .story-collapse {
	display: -webkit-box;
	display: -ms-flexbox;
	display: flex;
	-webkit-box-orient: horizontal;
...
.give-form-templates .campain-container .story-collapse .showhidebtn {
	background-color: #f4756b;
	color: #fff;
	border: 2px solid #f4756b;
	border-radius: 4px;
	padding: 10px 12px;
	font-size: 16px;
}
.give-form-templates .campain-container .story-collapse .showhidebtn:hover {
...
.give-form-templates .campain-story.story-active {
	display: block;
}
.give-form-templates .campain-story {
	display: none;
}
	.give-form-templates .campain-story p{
		margin: 10px 0;
		line-height:1.5;
	}
	
	
	.give-form-templates .campain-heading{
		margin-bottom:20px
	}
	.give-form-templates .peakfund-progress{
		background:#071B4D;
		height:10px;
		border-radius: 5px;
		position: relative;
	}
	.give-form-templates .peakfund-progress .dot{
		height:20px;
		width: 20px;
		background:#071B4D;
	...
	.give-form-templates .give-form-stats-panel-stat{
		color:#071B4D !important;
		font-weight:normal;
	}
	.give-form-templates .give-form-stats-panel-stat-number{
	...
	.give-form-templates .give-donation-amount .give-currency-symbol {
	padding: 5px 11px !important;
}
	.give-form-templates .give-donation-amount .give-text-input {
	padding-block: 0px;
	font-size: 30px;
}
    ...
    .give-form-templates .give-btn.give-btn-level-custom {
        font-size: 16px;
        word-spacing: unset;
    }
    .give-form-templates .give-form-section .give-amount-heading, .give-form-templates .give-form-section legend {
        font-size: 22px;
        display: none;
    }   
	.give-form-templates .give-donation-amount-section{
		row-gap: 15px;
	}
	.give-form-templates .give-form-section .give-donationtype-wrap {
    	display: none !important;
    }
	.give-form-templates .give-form-section {
		padding: 20px;
	}
	.give-form-templates .give-personal-info-section fieldset:not(.ffm-field-container>fieldset){
		row-gap: 12px;
	}
	.give-form-templates .give-input-field-wrapper, .give-select, .give-square-cc-fields, .give-stripe-single-cc-field-wrap, :where(.form-row,.give-gateway-details) :where(input[type=text],input[type=tel],input[type=email],input[type=url],input[type=password],textarea,select,.give-select,.give-stripe-cc-field):not(#give-amount){
		padding: 14px;
	}
	.give-form-templates .document-container{
		margin-top: 30px;
	}
	.give-form-templates .document-container .document-items {
	display: -webkit-box;
	display: -ms-flexbox;
	display: flex;
	-webkit-box-orient: horizontal;
...
.give-form-templates .document-container img {
	width: 31%;
	max-width: 100%;
}
	.give-form-templates .document-container h2{
		margin-bottom:10px
	}
    .give-form-templates .give-form-section #give-comment-wrap {
	display: none;
}
.give-form-templates .give-personal-info-section, .give-form-templates .give-payment-details-section {
	padding: 0px 20px;
}

.give-form-templates .give-personal-info-section #give_checkout_user_info {
	display: -webkit-box;
	display: -ms-flexbox;
	display: flex;
	-webkit-box-orient: horizontal;
...
.give-form-templates .give-personal-info-section legend, .give-form-templates .give-personal-info-section .give-personal-info-description, .give-form-templates .give-personal-info-section #give-anonymous-donation-wrap,
.give-form-templates #give-payment-mode-wrap #give_secure_site_wrapper, .give-form-templates .give-gateway-details .give_notices {
	width: 100%;
}
.give-form-templates .give-gateway-details .give_notices p {
	width: 100% !important;
}
.give-form-templates .give-personal-info-section .form-row-first, .give-form-templates .give-personal-info-section #give-email-wrap, 
.give-form-templates .give-payment-details-section .give-gateway-details .give-do-validate p {
	width: 48%;
}
.give-form-templates .give-personal-info-section .form-row-first {
	display: -webkit-box;
	display: -ms-flexbox;
	display: flex;
	-webkit-box-orient: horizontal;
	...
	border-radius: .25rem;
	-webkit-box-shadow: inset 0 .08em .4em rgba(0,0,0,.15);
	        box-shadow: inset 0 .08em .4em rgba(0,0,0,.15);
	-ms-grid-column-span: 12 !important;
	grid-column: span 12 !important;
}
.give-form-templates .give-personal-info-section .form-row-first:focus {
	outline: 1px solid #f4756b;
	border-color: #f4756b;
}
.give-form-templates .give-personal-info-section .form-row-first .give-input {
	border: none !important;
	-webkit-box-shadow: unset !important;
	        box-shadow: unset !important;
}
.give-form-templates .give-personal-info-section .form-row-first .give-input:focus {
	outline: unset !important;
}
.give-form-templates .give-personal-info-section .form-row-first #give-first {
	padding-right: 0px !important;
}
.give-form-templates .give-personal-info-section .form-row-first #give-last {
	padding-left: 0px !important;
}

.give-gateway-list-item .give-gateway-details {
	display: none;
}
.give-form-templates #give-gateway-radio-list {
	-webkit-box-orient: horizontal;
	-webkit-box-direction: normal;
	    -ms-flex-direction: row;
	        flex-direction: row;
...
.give-form-templates #give-gateway-radio-list .give-gateway-option-selected {
	background-color: #071b4d !important;
	color: #fff;
	font-weight: 400;
}
.give-form-templates #give-gateway-radio-list .give-gateway-list-item {
	padding: 10px 5px;
...
.give-form-templates #give-gateway-radio-list .give-gateway {
	position: inherit;
	display: none;
}
.give-form-templates #give-gateway-radio-list .give-gateway-option {
...
.give-form-templates .give-donation-form-summary-section, .give-form-templates #give-gateway-radio-list .give-gateway-option::after {
	display: none;
}
.give-form-templates .give-payment-details-section .give-gateway-details .give-do-validate {
	display: -webkit-box;
	display: -ms-flexbox;
	display: flex;
	-webkit-box-orient: horizontal;
...
@media all and (min-width: 561px) {
    .give-form-templates .give-donation-amount-section #give-cycle-wrap {
    	display: -webkit-box;
    	display: -ms-flexbox;
    	display: flex;
    	-webkit-box-align: center;
    ...
    .give-form-templates .give-donation-amount-section #give-cycle-wrap .give-label {
    	padding-right: 15px;
    }
    .give-form-templates .give-donation-amount-section #give-cycle-wrap #monthly {
    	margin-left: 20px;
    }
}
	@media all and (max-width: 980px) {
	/*======start give donation page========*/
	.give-form-templates .campain-col-left, .give-form-templates .campain-col-right{
		width:100%;
		padding-right:10px;
		padding-left:10px;
...
.give-form-templates .give-form-section p {
	font-size: 12px;
}
.give-form-templates #give-gateway-radio-list .give-gateway-list-item {
...
/*============End give donation single page style =============*/
    
    </style
	<h2 class="campain-heading"><?= ($form->post_title) ?></h2>
	<div class="campain-container">
	
		<div class="campain-col-left">
		    
			<img class="img-thumbnail" src="<?= get_the_post_thumbnail_url($form->ID) ?>" />
			<?php $hasGoal = $form->has_goal();
				$customGoalStats = customGetFormGoalStats($form);
			?>
			<?php if ($hasGoal) : ?>
<!-- 				<aside class="give-form-stats-panel">
					<ul class="give-form-stats-panel-list">
						<li class="give-form-stats-panel-stat">
							<span class="give-form-stats-panel-stat-number">
								<?= $customGoalStats[ 'raised' ]; ?>
							</span> <?= __('raised', 'give'); ?>
						</li>
						<li class="give-form-stats-panel-stat">
							<span class="give-form-stats-panel-stat-number">
								<?= $customGoalStats[ 'count' ]; ?>
							</span> <?= $customGoalStats[ 'countLabel' ]; ?>
						</li>
						<li class="give-form-stats-panel-stat">
							<span class="give-form-stats-panel-stat-number">
								<?= $customGoalStats[ 'goal' ]; ?>
							</span> <?= __('goal', 'give'); ?>
						</li>
						<li class="give-form-goal-progress">
							<div
								...
								style="--progress: <?= $customGoalStats[ 'progress' ]; ?>%"
								aria-label="<?= sprintf(__('%s of %s goal', 'give'), $customGoalStats[ 'raised' ], $customGoalStats[ 'goal' ]); ?>"
								aria-valuemin="0"
								aria-valuemax="<?= $customGoalStats[ 'goalRaw' ]; ?>"
								aria-valuenow="<?= $customGoalStats[ 'raisedRaw' ]; ?>"
								aria-valuetext="<?= $customGoalStats[ 'progress' ]; ?>%"
							>
							</div>
						</li>
					</ul>
				...
				<aside class="give-form-stats-panel">
					<ul class="give-form-stats-panel-list">
						...
						<li class="give-form-stats-panel-stat">
							To Go
							<span class="give-form-stats-panel-stat-number">
								$<?= $customGoalStats[ 'goalRaw' ] - $customGoalStats[ 'raisedRaw' ]; ?>
							</span>
						</li>
						<li class="give-form-goal-progress">
							<div class="peakfund-progress" style="width:<?= $customGoalStats[ 'progress' ]; ?>%">
								<div class="dot"></div>
							</div>
							<!-- <div
								role="meter"
            ...
            <div class="story-collapse">
				<h1>Story</h1>
            	<button class="showhidebtn">Show Story</button>
            </div>
			<div class="campain-story">
			...
			<div class="document-container">
                ...
                <div class="document-items">
                	<img src="<?= give_get_meta($form->ID, '_give_documents', true);?>"/>
                </div>
				
			</div>
		</div>

		<div id="give-form-<?php echo $form->ID; ?>-wrap" class="<?php echo $form_wrap_classes; ?> campain-col-right">
			<?php
	...
	<script>
		jQuery('body').css({'justify-content': 'normal', 'display': 'inherit'});
		...
		if(getParameterByName('amount')){
			...
			setTimeout(() => {
				jQuery('.give-btn-level-custom').click()
				jQuery('.give-amount-top').val(getParameterByName('amount')+'.00')
			}, 5000)
			
			
			jQuery('#onetime').attr('checked', 'checked')
			jQuery('select[name="donation_type"] option[value="'+getParameterByName('type')+'"]').attr('selected', 'selected')
		}
	</script>
	...
	<fieldset id="give_checkout_user_info" class="<?php echo esc_html( $title_prefix_classes ); ?>">
		...
		<p id="give-first-name-wrap" class="form-row form-row-first form-row-responsive">
			...
			<input
				...
				placeholder="<?php esc_attr_e( 'Enter your name', 'give' ); ?>"
				id="give-first"
				value="<?php echo esc_html( $first_name ); ?> <?php echo esc_html( $last_name ); ?>"
...
function give_payment_mode_select( $form_id, $args ) {
	...
	<fieldset id="give-payment-mode-select"<?php echo count( $gateways ) <= 1 ? ' style="display: none;"' : ''; ?>>
		...
		<div id="give-payment-mode-wrap">
            ...
            <div class="lrpayment-option-details">
